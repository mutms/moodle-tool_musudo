...
use tool_musudo\event\sudo_started;
use tool_musudo\local\sudoer;

/**
 * Sudo started event test.
 *
 * @group      MuTMS
 * @package    tool_musudo
 ...
 *
 * @covers \tool_musudo\event\sudoer_created
 */
final class sudo_started_test extends \advanced_testcase {
